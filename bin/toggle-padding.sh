...
if [ "$current_padding" == 450 ]; then
    ...
    sed -i 's/window_margin_width 8 [0-9][0-9][0-9]/window_margin_width 8 450/' "$KITTY_FILE"
    sed -i 's/font_size [0-9][0-9]/font_size 11/' "$KITTY_FILE"
fi;
